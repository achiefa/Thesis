...
\red{Dire che la parametrizzazione tramite NN è controllata dal codice NNAD, Ref.}\\
\red{Dire qualcosa sulla alta ridondanza della rete per renderla piu' flessibile e indipendente dall'architettura.}\\
